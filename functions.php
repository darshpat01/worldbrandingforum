...
function twentynineteen_scripts() {
	...
	wp_enqueue_style('owl', get_template_directory_uri(). '/sass/owl.css');
	wp_enqueue_style('g-font', 'https://fonts.googleapis.com/css?family=Raleway:400,500,600,700');
	...
	if ( has_nav_menu( 'menu-1' ) ) {
		...
		wp_enqueue_script( 'google', get_theme_file_uri( '/js/google.js' ),array(),'',true);
		wp_enqueue_script( 'bootstrap', get_theme_file_uri( '/js/bootstrap.min.js' ),array(),'',true);
		wp_enqueue_script( 'owl', get_theme_file_uri( '/js/owl.js' ),array(),'',true);
	}
